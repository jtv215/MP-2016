...
public class TestEstudianteEmpleado {
	...
	public void test() {
		...
		String cadenaEstudiante1 = "Estudiante de Grado\n"
				+ "Nombre = Francisco Rojas Alba, Direccion = Avd. Estación 5, Teléfono = 950224567, email = frojas@gmail.com";
		String cadenaEstudiante2 = "Estudiante de Master\n"
				+ "Nombre = Carmen Fernandez Martin, Direccion = C. Perú 9, Teléfono = 9504134157, email = cfermar@ual.es";
		String cadenaEstudiante3 = "Estudiante de Doctorado\n"
				+ "Nombre = Maria Gonzalez Segura, Direccion = Avd. Cabo de Gata 26 4º 1, Teléfono = 950234788, email = mariags@gmail.com";
		String cadenaProfesor1 = "Profesor Ayudante\n"
				+ "Nombre = Antonio Lopez Gimenez, Direccion = C. Tirso de Molina 6, Teléfono = 950014678, email = alopez@ual.es\n"
		...
		String cadenaProfesor2 = "Profesor Titular de Universidad\n"
				+ "Nombre = Angeles Abad Martinez, Direccion = C. Cervantes 32, Teléfono = 950018987, email = abad@ual.es\n"
		...
		String cadenaProfesor3 = "Profesor Catedrático de Universidad\n"
				+ "Nombre = Jose Garcia Perales, Direccion = C. Jacinto 12, Teléfono = 950019060, email = jgarcia@ual.es\n"
		...
		String cadenaAdministrativo = "Administrativo\n"
				+ "Nombre = Sergio Morales Parra, Direccion = Avd. Pablo Iglesias 78, Teléfono = 950017080, email = smorales@ual.es\n"
